...
import com.example.alumnos.alumni.Dialogpojo;
...
import com.example.alumnos.alumni.DialogAdaptorStudent;
public class HwAdapter extends BaseAdapter {
    ...
    public HwAdapter(Fragment context, GregorianCalendar monthCalendar,ArrayList<HomeCollection> date_collection_arr) {
    ...
    public void getPositionList(String date,final Activity act){
        ...
        if (jbarrays.length()!=0) {
            final Dialog dialogs = new Dialog(context.getActivity());
